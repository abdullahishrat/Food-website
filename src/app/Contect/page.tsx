...
const page = () => {
  return (
    <div><div className="container my-12 mx-auto px-2 md:px-4">
        ...
        <div className="flex flex-wrap">
            ...
            <form className="mb-12 w-full shrink-0 grow-0 basis-auto md:px-3 lg:mb-0 lg:w-5/12 lg:px-6">
                ...
                <div className="mb-3 w-full">
                    <label className="block font-medium mb-[2px] text-gray-900" htmlFor="exampleInput90">
                            Name
                    </label>
                ...
                <button type="button"
                        className="mb-6 inline-block w-full rounded bg-gray-900 px-6 py-2.5 font-medium uppercase leading-normal text-white hover:shadow-md hover:bg-gray-600">
                        Send
                </button>
            ...
            <div className="w-full shrink-0 grow-0 basis-auto lg:w-7/12">
                <div className="flex flex-wrap">
                    ...
                    <div className="mb-12 w-full shrink-0 grow-0 basis-auto md:w-6/12 md:px-3 lg:px-6">
                        <div className="flex items-start">
                            <div className="shrink-0">
                                <div className="inline-block rounded-md bg-teal-400-100 p-4 text-gray-900">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                        stroke-width="2" stroke="currentColor" className="h-6 w-6">
                                        <path stroke-linecap="round" stroke-linejoin="round"
