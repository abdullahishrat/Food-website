      ...
      <div id="about" className="relative bg-white overflow-hidden mt-16">
        ...
        <div className="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2 mb-9">
          <img
            ...
            src="https://www.southernliving.com/thmb/L_mvgsEQbqJUIYkOwbJJLk-Z4qA=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/26887_CheeseAppetizers_0484_Creamy-Spinach-Ricotta-Crostini-2000-92ef12e26ea1426991e251424167f7ca.jpg"
            alt=""
          />
        </div>
      </div>
